...
export default function Artistic() {
    ...
    return (
        <div className={`${styles.artisticMainDiv} ${playfair_display.variable}`} style={{ backgroundColor: "#fff" }}>
            ...
            <section className={`${styles.darkBackdrop}`} style={{ paddingBlock: "5rem", backgroundImage: `url(${require("../../../public/homepages/artsectionbg1.png").default.src})`, backgroundColor: "pink" }}>
