...
function ToDoList() {
	...
	const [todosSelectedState, setTodosSelectedState] = useState()
	...
	function handleSelectedState(option, id=undefined){
		//and changeState
		if (option === "changeAmount"){
			...
			setTodosSelectedState((prevSelectedState) => {
				...
				return {...prevSelectedState, [id] : !prevSelectedState[id]}
			})
		}
	}
